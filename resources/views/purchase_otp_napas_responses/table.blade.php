            ...
            <tr>
                ...
                <td><!-- Trigger the modal with a button -->
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                            data-target="#dataKey_{{$purchaseOtpNapasResponse->id}}">DISPLAY
                    </button>
                ...
                <td><!-- Trigger the modal with a button -->
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                            data-target="#napasKey_{{$purchaseOtpNapasResponse->id}}">DISPLAY
                    </button>
                ...
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('purchaseOtpNapasResponses.show', [$purchaseOtpNapasResponse->id]) }}"
                           class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('purchaseOtpNapasResponses.edit', [$purchaseOtpNapasResponse->id]) }}"
                           class='btn btn-default btn-xs'>
