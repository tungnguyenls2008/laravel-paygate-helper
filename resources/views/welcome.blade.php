...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="{{route('welcome')}}">Paygate Helper</a></h1>
...
<section id="hero">
    <div class="hero-container">
        <h3>Welcome to <strong>Paygate Helper</strong></h3>
...
<footer id="footer">
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="mr-md-auto text-center text-md-left">
            <div class="copyright">
                &copy; Copyright <strong><span>Paygate Helper</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
